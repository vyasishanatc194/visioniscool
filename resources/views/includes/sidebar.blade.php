<div class="app-sidebar menu-fixed" data-background-color="man-of-steel"
    ...
    <div class="sidebar-header">
        <div class="logo clearfix"><a class="logo-text float-left" href="/">
                ...
                <span class="text">Vision Is Cool</span>
            </a>
        </div>
    </div>
    <!-- Sidebar Header Ends-->
    ...
    <div class="sidebar-content main-menu-content">
        <div class="nav-container">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                {{-- <li class=" nav-item"><a href="/"><i class="ft-home"></i><span class="dashboarl-title"
                            data-i18n="Dashboard">Dashboard</span></a>
                </li> --}}
                <li class="has-sub nav-item"><a href="{{url('/')}}"><i class="ft-list"></i><span class="menu-title" data-i18n="Forms">Gallary</span></a>
                    <ul class="menu-content">
                        <li><a href="{{route('gallary.index')}}"><i class="ft-arrow-right submenu-icon"></i><span class="menu-item"
                                    data-i18n="Gallary list">Gallary </span></a>
                        </li>
