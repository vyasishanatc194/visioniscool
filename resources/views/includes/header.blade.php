            ...
            <div class="collapse navbar-collapse d-block" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown nav-item mr-1"><a
                            ...
                            <div class="user d-md-flex d-none mr-2"><span class="text-right">{{\Auth::user()->full_name}}</span><span
                                    class="text-right text-muted font-small-3">Available</span></div><img class="avatar"
                                src="{{ asset('app-assets/img/portrait/small/avatar-s-1.png')}}" alt="avatar" height="35"
                                width="35">
                        </a>
